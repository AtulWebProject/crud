...
<style type="text/css">
  ...
  <div class="content-wrapper qbody"  style="padding: 2px;">
    ...
    <div class="container-fluid">
      <form method="post" action="<?php echo e(route('editmetadata')); ?>" enctype="multipart/form-data" id="metadataform">
        <?php echo csrf_field(); ?>
     <div class="row">
          <div class="col-md-12" id="addmetadataloader"></div>
          <div class="col-md-3" id="show">
           <img src="<?php echo e(asset('user_profile_image')); ?>/<?php echo e($get['image']); ?>">
           <input type='hidden' name='imageurl' value="<?php echo e($get['image']); ?>">
        ...
        <input id="title" class="form-control inputHolder" type="text" value="<?php echo e($get['description']); ?>" name="caption">
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="" class="form-control inputHolder" value="<?php echo e($get['description']); ?>" type="text" name="description" id="description"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" type="text" value="<?php echo e($get['comment']); ?>" name="comment" id=""> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['longitude']); ?>" type="text" name="longitude" id="longitude" required> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['latitude']); ?>" type="text" name="latitude" id="latitude" required> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['tag']); ?>" type="text" name="tag" id="tagsinput" data-role="tagsinput"> 
        <?php $__errorArgs = ['latitude'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['author']); ?>" type="text" name="artist" id="artist"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['organisation']); ?>" type="text" name="organation" id="organation"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['document_name']); ?>" type="text" name="docname" id="docname"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['program_name']); ?>" type="text" name="programname" id="programname"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['copyright']); ?>" type="text" name="copyright" id="copyright"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <input class="form-control inputHolder" value="<?php echo e($get['camera_model']); ?>" type="text" name="cameramodel" id="cameramodel"> 
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\seo\resources\views/editmetadata.blade.php ENDPATH**/ ?>